...
class rdk:
    ...
    def __parse_deploy_args(self, ForceArgument=False):
        ...
        if "rdk_lib_version" in self.args and ("rdklib_layer_arn" in self.args or "generated_lambda_layer" in self.args):
        ...
        #RDKLib version and RDKLib Layer ARN/Generated RDKLib Layer are mutually exclusive.
        if "rdklib_layer_arn" in self.args and "generated_lambda_layer" in self.args:
